...
`rtl_fm`, resampling and upmixing to stereo through `sox` into the shared
FIFO. All rtl_fm/USB-chipset-specific logic lives in this one file -- if
...
def build_command(instance: dict, frequency: str, fifo_pipe: str) -> str:
    # sox does the 24k->48k resample AND the mono->stereo upmix (`remix 1 1`
